...
@section('content')
    ...
    <div class="my-3">
        <a href="{{route('user#home')}}" class="text-dark text-decoration-none ms-5">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="{{route('pizza#detail',$p->id)}}"><i class="fa-solid fa-info"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            ...
                            <div class="">
                                <small>{{$p->view_count +1}}<i class="fa-solid fa-eye ms-1"></i></small>
                            </div>
                        </div>
                    </div>
                    @endforeach
