                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block me-5">
                            <div class="dropdown me-5">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item m-2" href="{{route('user#accountChangePage')}}"><i class="fa-solid fa-user"></i>
                                            Account
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item m-2" href="{{ route('user#changePwPage') }}">
                            ...
                            {{-- <a href="" class="text-decoration-none btn px-0 ml-3 text-white">
                                <i class="fa-solid fa-user"></i> {{Auth::user()->name}} |
                            </a>
                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                @csrf
